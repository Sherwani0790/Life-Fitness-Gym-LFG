...
export function ViewDetailsDialog({ isOpen, onClose, trainer }: ViewDetailsDialogProps) {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-[425px] p-0 overflow-hidden border-none shadow-2xl">
        <DialogHeader className="p-6 bg-transparent border-b border-border/50">
          <DialogTitle className="text-lg font-bold">Trainer Profile</DialogTitle>
        </DialogHeader>
