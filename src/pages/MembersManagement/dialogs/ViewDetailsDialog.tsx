...
export function ViewDetailsDialog({ isOpen, onClose, member }: ViewDetailsDialogProps) {
        ...
        <div className="p-6 space-y-6 bg-background">
          ...
          <div className="grid grid-cols-2 gap-y-4 gap-x-6 border-t border-border pt-6">
            ...
            <div className="space-y-1">
              ...
              <p className="text-xs font-medium text-foreground">{member.cnic}</p>
            </div>
            <div className="space-y-1">
              <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Gender</p>
              <p className="text-xs font-medium text-foreground capitalize">{member.gender}</p>
            </div>
            <div className="space-y-1">
              <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Phone</p>
              <p className="text-xs font-medium text-foreground">{member.phone}</p>
            </div>
            <div className="space-y-1">
              <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Join Date</p>
              <p className="text-xs font-medium text-foreground">{member.joinDate}</p>
            </div>
            <div className="space-y-1">
              <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Start Date</p>
              <p className="text-xs font-medium text-foreground">{member.startDate || 'N/A'}</p>
            </div>
            <div className="space-y-1">
              <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Package</p>
              <p className="text-xs font-medium text-foreground">{member.packageName || 'N/A'}</p>
            </div>
            <div className="space-y-1">
              <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Location</p>
              <p className="text-xs font-medium text-foreground">{member.location}</p>
            </div>
            <div className="space-y-1">
              <p className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider">Payment Mode</p>
              <p className="text-xs font-medium text-foreground">{member.paymentMode}</p>
            </div>
          </div>
        </div>
